...
import edu.kit.ipd.sdq.kamp4aps.model.modificationmarks.provider.KAPSSeedModificationsItemProvider;
 ...
 * @generated
 */
public class APSReqSeedModificationsItemProvider extends KAPSSeedModificationsItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(APSReqModificationmarksPackage.Literals.APS_REQ_SEED_MODIFICATIONS__REQUIREMENT_MODIFICATIONS);
			childrenFeatures
					.add(APSReqModificationmarksPackage.Literals.APS_REQ_SEED_MODIFICATIONS__DECISION_MODIFICATIONS);
			childrenFeatures
					.add(APSReqModificationmarksPackage.Literals.APS_REQ_SEED_MODIFICATIONS__OPTION_MODIFICATIONS);
		}
	...
	/**
	 * This returns APSReqSeedModifications.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
