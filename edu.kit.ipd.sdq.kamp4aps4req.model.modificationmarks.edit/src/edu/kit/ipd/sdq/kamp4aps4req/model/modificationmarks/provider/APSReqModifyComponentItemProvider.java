...
import edu.kit.ipd.sdq.kamp4aps.model.modificationmarks.provider.ModifyComponentItemProvider;
 ...
 * @generated
 */
public class APSReqModifyComponentItemProvider extends ModifyComponentItemProvider {
	/**
	...
	/**
	 * This returns APSReqModifyComponent.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		String label = APSReqLabelCustomizing.customize((APSReqModifyComponent) object);
		// --End manually modified code
		return label == null || label.length() == 0 ? getString("_UI_APSReqModifyComponent_type")
