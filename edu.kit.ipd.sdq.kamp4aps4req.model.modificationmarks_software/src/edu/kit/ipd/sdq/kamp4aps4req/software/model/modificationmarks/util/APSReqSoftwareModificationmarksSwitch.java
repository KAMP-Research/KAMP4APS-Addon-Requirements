 ...
 * @generated
 */
public class APSReqSoftwareModificationmarksSwitch<T1> extends Switch<T1> {
	/**
	 ...
	 * @generated
	 */
	public APSReqSoftwareModificationmarksSwitch() {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case APSReqSoftwareModificationmarksPackage.APS_REQ_SOFTWARE_SEED_MODIFICATIONS: {
			...
			case APSReqSoftwareModificationmarksPackage.APS_REQ_SOFTWARE_MODIFICATION_REPOSITORY: {
			...
			case APSReqSoftwareModificationmarksPackage.APS_REQ_SOFTWARE_CHANGE_PROPAGATION_DUE_TO_SPECIFICATION_DEPENDENCIES: {
			...
			case APSReqSoftwareModificationmarksPackage.APS_REQ_MODIFY_IEC_COMPONENT: {
...
} //APSReqSoftwareModificationmarksSwitch
