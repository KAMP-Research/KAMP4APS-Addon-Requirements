...
/**
 * This is the action bar contributor for the APSReqModificationmarks model
 * editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class APSReqModificationmarksActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			APSReqModificationmarksEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			APSReqModificationmarksEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				APSReqModificationmarksEditorPlugin.INSTANCE.getString("_UI_APSReqModificationmarksEditor_menu"),
				"edu.kit.ipd.sdq.kamp4aps4req.model.modificationmarksMenuID");
		...
		createChildMenuManager = new MenuManager(
				APSReqModificationmarksEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				APSReqModificationmarksEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
