...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>APS Req Hardware Option</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apshardwareoptions.impl.APSReqHardwareOptionImpl#getEntities <em>Entities</em>}</li>
 *   <li>{@link apshardwareoptions.impl.APSReqHardwareOptionImpl#getEntityType <em>Entity Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class APSReqHardwareOptionImpl extends APSReqOptionImpl implements APSReqHardwareOption {
	 ...
	 * @generated
	 */
	protected APSReqHardwareOptionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApshardwareoptionsPackage.Literals.APS_REQ_HARDWARE_OPTION;
	}
	...
	public EList<Entity> getEntities() {
		if (entities == null) {
			entities = new EObjectResolvingEList<Entity>(Entity.class, this, ApshardwareoptionsPackage.APS_REQ_HARDWARE_OPTION__ENTITIES);
		}
		return entities;
	}
	...
	public void setEntityType(EntityType newEntityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApshardwareoptionsPackage.APS_REQ_HARDWARE_OPTION__ENTITY_TYPE, oldEntityType, entityType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApshardwareoptionsPackage.APS_REQ_HARDWARE_OPTION__ENTITIES:
				return getEntities();
