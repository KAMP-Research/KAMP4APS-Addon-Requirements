 ...
 *   <li>{@link apshardwareoptions.impl.APSReqChangeEntitiesImpl#getEntityType <em>Entity Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class APSReqChangeEntitiesImpl extends APSReqChangeOptionImpl implements APSReqChangeEntities {
	...
	public void setEntityType(EntityType newEntityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApshardwareoptionsPackage.APS_REQ_CHANGE_ENTITIES__ENTITY_TYPE, oldEntityType, entityType));
	}
