 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps4req.hardware.model.modificationmarks.impl.APSReqHardwareSeedModificationsImpl#getRequirementModifications <em>Requirement Modifications</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps4req.hardware.model.modificationmarks.impl.APSReqHardwareSeedModificationsImpl#getDecisionModifications <em>Decision Modifications</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps4req.hardware.model.modificationmarks.impl.APSReqHardwareSeedModificationsImpl#getOptionModifications <em>Option Modifications</em>}</li>
 * </ul>
 *
 * @generated
 */
public class APSReqHardwareSeedModificationsImpl extends KAMP4aPSSeedModificationsImpl implements APSReqHardwareSeedModifications {
	...
	protected EClass eStaticClass() {
		return APSReqHardwareModificationmarksPackage.Literals.APS_REQ_HARDWARE_SEED_MODIFICATIONS;
	}
	...
	public EList<APSReqModifyRequirement> getRequirementModifications() {
		if (requirementModifications == null) {
			requirementModifications = new EObjectContainmentEList<APSReqModifyRequirement>(APSReqModifyRequirement.class, this, APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__REQUIREMENT_MODIFICATIONS);
		}
	...
	public EList<APSReqModifyDecision> getDecisionModifications() {
		if (decisionModifications == null) {
			decisionModifications = new EObjectContainmentEList<APSReqModifyDecision>(APSReqModifyDecision.class, this, APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__DECISION_MODIFICATIONS);
		}
	...
	public EList<APSReqModifyOption> getOptionModifications() {
		if (optionModifications == null) {
			optionModifications = new EObjectContainmentEList<APSReqModifyOption>(APSReqModifyOption.class, this, APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__OPTION_MODIFICATIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__REQUIREMENT_MODIFICATIONS:
				return ((InternalEList<?>)getRequirementModifications()).basicRemove(otherEnd, msgs);
			case APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__DECISION_MODIFICATIONS:
				return ((InternalEList<?>)getDecisionModifications()).basicRemove(otherEnd, msgs);
			case APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__OPTION_MODIFICATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == APSReqSeedModifications.class) {
			switch (derivedFeatureID) {
				case APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__REQUIREMENT_MODIFICATIONS: return APSReqModificationmarksPackage.APS_REQ_SEED_MODIFICATIONS__REQUIREMENT_MODIFICATIONS;
				case APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__DECISION_MODIFICATIONS: return APSReqModificationmarksPackage.APS_REQ_SEED_MODIFICATIONS__DECISION_MODIFICATIONS;
				case APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__OPTION_MODIFICATIONS: return APSReqModificationmarksPackage.APS_REQ_SEED_MODIFICATIONS__OPTION_MODIFICATIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == APSReqSeedModifications.class) {
			switch (baseFeatureID) {
				case APSReqModificationmarksPackage.APS_REQ_SEED_MODIFICATIONS__REQUIREMENT_MODIFICATIONS: return APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__REQUIREMENT_MODIFICATIONS;
				case APSReqModificationmarksPackage.APS_REQ_SEED_MODIFICATIONS__DECISION_MODIFICATIONS: return APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__DECISION_MODIFICATIONS;
				case APSReqModificationmarksPackage.APS_REQ_SEED_MODIFICATIONS__OPTION_MODIFICATIONS: return APSReqHardwareModificationmarksPackage.APS_REQ_HARDWARE_SEED_MODIFICATIONS__OPTION_MODIFICATIONS;
				default: return -1;
			}
		}
